...
if __name__ == '__main__':  
    for lr in [0.001, 0.0025, 0.0001]:
        for epoch in [800]:
            # for m,f,n in [
            #                 ["vit_small_patch16", f"model_path", "save_path"],
            # ]:
                for seed in [42,1004,2023]:
                    ...
                    args.output_dir     = f"{path}/{n}/{lr}/{seed}"
...
#                 args.average        = "weighted"
#                 args.data_type      = "multi-class"
#                 args.best_model     = "accuracy"
#                 args.optimizer      = "adamw"
...
#                 args.train_list     = f"{train_path}/train_p.txt"
#                 args.val_list       = f"{train_path}/val_p.txt"
#                 args.test_list      = f"{train_path}/test_p.txt"

#                 args.output_dir     = f"{path}/{n}/{lr}/{args.seed}"
#                 args.log_dir        = f"{path}/{n}/{lr}/{args.seed}"
#                 if args.output_dir:
#                     Path(args.output_dir).mkdir(parents=True, exist_ok=True)
#                 main(args)