...
def get_args_parser():
    ...
    parser.add_argument('--mask_ratio', default=0.6, type=float,                                                                         #revise
    ...
    parser.add_argument('--curri', default=False)
...
def main(args):
    ...
    model = models_curriMAE.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, img_size=args.input_size,
